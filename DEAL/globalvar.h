...
typedef enum
{
	...
	TEST_PORT_SEND_MODE,//通讯测试  主板
	TEST_PORT_RECV_MODE,//通讯测试  被测板子
	LOAD_TEST_MODE		//负载测试
}System_Mode;//系统的工作模式
...
extern ROM_FLASH_PARAM updatDataRam;	//程序升级相关参数结构体变量
extern VCI_RunVar varVciRun;			//VCI部分，运行参数
extern BXWAllData varBXWRun;			//便携王部分，运行状态信息
extern SYSTEM_Var varOperaRun;			//系统运行参数
extern VCICAN_Data canVCIData;			//VCI CAN运行参数
