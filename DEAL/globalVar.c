...
void GloVar_Init(void)
{
	...
	//便携王发送信息初始化	
	varBXWRun.cmd1Len = 14;
	varBXWRun.cmd2Len = 17;
	varBXWRun.cmd3Len = 13;
	varBXWRun.cmd4Len = 9;
	varBXWRun.cmd5Len = 10;
	varBXWRun.cmd6Len = 19;
	varBXWRun.cmd7Len = 19;
	varBXWRun.cmd8Len = 16;
//	varBXWRun.cmd9Len = 13;
	
	varBXWRun.cmd1Id = 0x01;
	varBXWRun.cmd2Id = 0x02;
	varBXWRun.cmd3Id = 0x03;
	varBXWRun.cmd4Id = 0x04;
	varBXWRun.cmd5Id = 0x05;
	varBXWRun.cmd6Id = 0x06;
	varBXWRun.cmd7Id = 0x07;
	varBXWRun.cmd8Id = 0x08;
//	varBXWRun.cmd9Id = 0x09;
	
	//系统运行参数变量初始化
	
	varOperaRun.sysMode = IDLE_MODE;//空闲模式
	varOperaRun.dat595 = 0x007D;	//LED灯的初始状态
	varOperaRun.cmdIdCAN = 0;
	varOperaRun.cmdIdK   = 0;
